...
<head>
	...
	function updateCanvas(canvasJq, blkEls)
	{
        ...
        // move nucleus calculations out of loop
	...
	$(document).ready(function(){updateCanvas($("#canvas"), $(".node"));});
	...
	$(function() {
        ...
        $(".ui-draggable").livequery(function() { $(this).draggable({
			drag: function() {
                // this is not called for Node D
        ...
        $("#add-node-button").click(function() {
            ...
            // unbind draggable behaviour
            // (re)bind draggable behaviour?
